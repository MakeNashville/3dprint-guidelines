...
Orientations are held biweekly, are open to all skill levels, and require pre-registration on Eventbrite. Currently orientations fill up quickly, we recommend snagging a spot quickly. Register on Eventbrite by searching or scanning the QR code. 
Attending an orientation is not required to print but encouraged. If you do not abide by the rules and guidelines of the shop, you may be required to retake orientation before using the shop again. 
